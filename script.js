const translations = {
  ...
  bg: {
    ...
    "about.copy": "Аз съм IT Operations и Service Management професионалист с 4+ години практически опит в ръководене на екип, project coordination, business continuity, Service Desk, application management и Atlassian Cloud администрация.",
    "about.copy2": "Ръководил съм екипи и съм координирал проекти, в които бизнес приоритети, технически ограничения и оперативен риск трябва да се движат заедно. Най-силната ми зона е да превръщам тази сложност в Jira и JSM workflows, SLA логика, автоматизации, dashboards и ясна ownership структура.",
    "about.copy3": "Имам и практически познания в AI-supported tools и integrations - от Gemini-assisted Jira автоматизации до data-driven reporting, които намаляват ръчната работа и помагат за по-бързи, по-добре документирани решения.",
    "about.card1Title": "Team & project leadership",
    "about.card1Text": "Ръководене на екипи, управление на приоритети, координация със stakeholders и delivery на проекти от assessment и testing до rollout и adoption.",
    "about.card2Title": "Application management",
    "about.card2Text": "Ownership на критични приложения, incidents, escalations, vendor coordination, access processes, reporting и service reliability.",
    "about.card3Title": "Atlassian, automation & AI",
    "about.card3Text": "Jira, JSM и Confluence администрация с permissions, workflows, SLAs, dashboards, Marketplace apps, integrations и AI-supported automations.",
