const translations = {
  ...
  bg: {
    ...
    "signal.itsm": "ITSM",
    "signal.atlassian": "Атласиан облак",
    ...
    "about.copy": "Аз съм професионалист в ИТ операции и управление на услуги с 4+ години практически опит в ръководене на екип, координация на проекти, непрекъснатост на бизнеса, сервизно обслужване, управление на приложения и администрация на Атласиан облак.",
    ...
    "expertise.card1Text": "Администрация на Атласиан облак в мащаб, оптимизация на жизнения цикъл на услугите, отговорност, проследимост, права, форми и табла.",
    ...
    "contact.copy": "Отворен към роли и проекти в ИТ операции, Атласиан облак, управление на услуги, автоматизация и непрекъснатост на бизнеса.",
    "footer.text": "ИТ операции | Атласиан облак | Непрекъснатост на бизнеса",
